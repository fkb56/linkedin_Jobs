// Import des types séparément pour TypeScript
import {
  IExecuteFunctions,
  INodeExecutionData,
  INodeType,
  ...
  async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
    ...
    try {
      ...
      throw new NodeOperationError(
        this.getNode(),
        'Le package "linkedin-jobs-api" n\'est pas installé. Installez-le avec: npm install linkedin-jobs-api'
      );
    }
      ...
      try {
        if (resource === 'job' && operation === 'search') {
          ...
          const queryOptions: any = {
            ...
            dateSincePosted: this.getNodeParameter('dateSincePosted', i) as string,
            jobType: this.getNodeParameter('jobType', i) as string,
            remoteFilter: this.getNodeParameter('remoteFilter', i) as string,
            salary: this.getNodeParameter('salary', i) as string,
            experienceLevel: this.getNodeParameter('experienceLevel', i) as string,
